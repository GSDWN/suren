...
public class PersistenceConfig
{
    ...
    public void initBean(){
        url = env.getProperty("com.artronics.gsdwn.suren.persistence.url");
        driver = env.getProperty("com.artronics.gsdwn.suren.persistence.driver");
        username = env.getProperty("com.artronics.gsdwn.suren.persistence.username");
        password = env.getProperty("com.artronics.gsdwn.suren.persistence.password");
        dialect = env.getProperty("com.artronics.gsdwn.suren.persistence.dialect");
        hbm2ddl = env.getProperty("com.artronics.gsdwn.suren.persistence.hbm2ddl");
    }
